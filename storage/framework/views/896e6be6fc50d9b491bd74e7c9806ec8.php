    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <form action="<?php echo e(route('admin.sliders.update', $slider->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <img src="<?php echo e(asset($slider->image)); ?>" class="w-64 rounded border shadow-sm mb-2">
        ...
        <div id="slider" class="flex transition-transform duration-700 ease-in-out">
            <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <img src="<?php echo e(asset($slider->image)); ?>" 
                     alt="<?php echo e($slider->alt ?? 'Dishine Slider'); ?>" 
                     class="w-full h-auto object-cover max-h-[550px] flex-shrink-0">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <!-- Fallback jika tidak ada slider di database -->
                <img src="<?php echo e(asset('modelhome.png')); ?>" alt="Default Slider" class="w-full h-auto object-cover max-h-[550px] flex-shrink-0">
            <?php endif; ?>
        </div>
    </div>
    ```
