            ...
            <form action="<?php echo e(route('admin.orders')); ?>" method="GET">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="<?php echo e(route('admin.orders')); ?>" class="flex-1 bg-[#8B6F47] text-white px-4 py-3 rounded-xl hover:bg-[#725a38] font-semibold text-sm flex items-center justify-center transition-all">
        ...
        <div class="bg-gradient-to-r from-[#EBE6E6] to-[#F0E7DB] px-8 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 text-gray-700">
                    ...
                    <span class="text-sm font-semibold">Total Pesanan: <span class="text-[#CC8650] font-bold"><?php echo e($orders->total()); ?></span></span>
                </div>
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-[#F0E7DB] hover:to-transparent transition-all duration-150">
                            ...
                            <td class="px-8 py-5 whitespace-nowrap">
                                <div class="flex items-center text-sm text-gray-700">
                                    ...
                                    <span class="font-medium"><?php echo e(\Carbon\Carbon::parse($order->tanggal_pesan)->format('d M Y')); ?></span>
                                </div>
                                <span class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($order->tanggal_pesan)->format('H:i')); ?></span>
                            </td>
                            <td class="px-8 py-5 whitespace-nowrap">
                                <div class="flex items-center">
                            ...
                            <td colspan="7" class="text-center py-16">
                                <div class="flex flex-col items-center">
                                    <?php if(request()->has('search_nama') || request()->has('tanggal_mulai')): ?>
                                        ...
                                        <a href="<?php echo e(route('admin.orders')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#CC8650] to-[#D4BA98] text-white rounded-xl font-semibold hover:shadow-lg transition-all">
            ...
            <div class="bg-gradient-to-r from-[#EBE6E6] to-[#F0E7DB] px-8 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-600">
                        Menampilkan <span class="font-bold text-[#CC8650]"><?php echo e($orders->firstItem()); ?></span> - <span class="font-bold text-[#CC8650]"><?php echo e($orders->lastItem()); ?></span> dari <span class="font-bold text-[#CC8650]"><?php echo e($orders->total()); ?></span> pesanan
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Aulia\dataD\KULIAH\PJBL\dishine\resources\views/admin/orders.blade.php ENDPATH**/ ?>