        ...
        <form action="/register" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" id="alamat"
                    class="w-full p-2 border rounded focus:ring-0 focus:border-opacity-100"
                    style="border-color: #CC8550; color: #AE8B56;" required><?php echo e(old('alamat')); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\althof\Documents\KULYEAH\SEMESTER 3\pjbl lagi\dishine\resources\views/auth/register.blade.php ENDPATH**/ ?>