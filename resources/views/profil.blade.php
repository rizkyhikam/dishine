...
@section('title', 'Profil Saya - Dishine')
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-white text-opacity-90">{{ ucfirst($user->role) }} Account</p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-800 capitalize">{{ $user->role ?? 'guest' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-lg font-semibold text-gray-800 whitespace-pre-line">{{ $user->alamat ?? 'Belum diatur' }}</p>
                                    @if(!$user->alamat)
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-800">{{ $user->no_hp ?? 'Belum diatur' }}</p>
                                    @if(!$user->no_hp)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="alamat" name="alamat" rows="4"
                                          class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:border-[#CC8650] focus:ring-2 focus:ring-[#CC8650] focus:ring-opacity-20 transition-all"
                                          placeholder="Jl. Mawar No. 10, RT 01/RW 02, Kelurahan, Kecamatan, Kota, Kode Pos">{{ old('alamat', $user->alamat ?? '') }}</textarea>
                                <p class="text-xs text-gray-500 mt-2 flex items-center">
