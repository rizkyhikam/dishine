        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-6">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="flex items-center">
                    <a href="/" class="inline-block">
                        <img src="{{ asset('logo.png') }}" alt="Dishine Logo" class="h-10 lg:h-12 w-auto object-contain">
                    </a>
                </div>
                ...
                <div class="hidden lg:flex items-center flex-1 justify-end space-x-6">
                    ...
                    <!-- Menu Items -->
                    <a href="/" class="flex items-center text-[#3c2f2f] hover:text-[#CC8650] space-x-2 transition-colors px-3 py-2 rounded-lg hover:bg-white/50 {{ request()->is('/') ? 'text-[#CC8650] font-semibold bg-white/70' : '' }}">
                        <i data-lucide="home" class="w-5 h-5"></i>
                        <span class="text-sm font-medium">Beranda</span>
                    </a>

                    <a href="/katalog" class="flex items-center text-[#3c2f2f] hover:text-[#CC8650] space-x-2 transition-colors px-3 py-2 rounded-lg hover:bg-white/50 {{ request()->is('katalog*') ? 'text-[#CC8650] font-semibold bg-white/70' : '' }}">
                    ...
                    @auth
                        <!-- Pesanan -->
                        <a href="{{ route('orders.view') }}" class="flex items-center text-[#3c2f2f] hover:text-[#CC8650] space-x-2 transition-colors px-3 py-2 rounded-lg hover:bg-white/50 {{ request()->is('orders*') ? 'text-[#CC8650] font-semibold bg-white/70' : '' }}">
                        ...
                        <a href="/profil" class="flex items-center space-x-2 px-4 py-2 rounded-full bg-white border-2 border-[#d6c3b3] hover:border-[#CC8650] transition-all shadow-sm">
                            <div class="h-8 w-8 rounded-full bg-gradient-to-br from-[#CC8650] to-[#D4BA98] flex items-center justify-center text-white font-bold shadow-sm">
                                {{ substr(explode(' ', Auth::user()->nama)[0], 0, 1) }}
                            </div>
                            <span class="text-sm font-semibold text-[#3c2f2f]">{{ explode(' ', Auth::user()->nama)[0] }}</span>
                        </a>
                    @else
                        <!-- Login Button -->
            ...
            <div id="mobileMenu" class="mobile-menu lg:hidden border-t border-[#d6c3b3] bg-white/50 backdrop-blur-sm">
                <div class="py-4 space-y-2 px-4">
                    ...
                    <a href="/" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white transition-colors {{ request()->is('/') ? 'bg-white text-[#CC8650] font-semibold' : 'text-[#3c2f2f]' }}">
                        <i data-lucide="home" class="w-5 h-5"></i>
                        <span>Beranda</span>
                    </a>

                    <a href="/katalog" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white transition-colors {{ request()->is('katalog*') ? 'bg-white text-[#CC8650] font-semibold' : 'text-[#3c2f2f]' }}">
                        <i data-lucide="tag" class="w-5 h-5"></i>
                        <span>Katalog</span>
                    </a>

                    @auth
                        <a href="{{ route('orders.view') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white transition-colors {{ request()->is('orders*') ? 'bg-white text-[#CC8650] font-semibold' : 'text-[#3c2f2f]' }}">
                            <i data-lucide="package" class="w-5 h-5"></i>
                            <span>Pesanan Saya</span>
                        </a>

                        <a href="/profil" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-white transition-colors {{ request()->is('profil*') ? 'bg-white text-[#CC8650] font-semibold' : 'text-[#3c2f2f]' }}">
                            ...
                            <span>{{ explode(' ', Auth::user()->nama)[0] }}</span>
                        </a>
                    @else
        ...
        <div class="max-w-7xl mx-auto px-4 lg:px-6">
            ...
            <div class="hidden lg:flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <img src="{{ asset('logo.png') }}" alt="Dishine Logo" class="h-10 brightness-200">
                    <div>
            ...
            <div class="lg:hidden text-center space-y-4">
                <img src="{{ asset('logo.png') }}" alt="Dishine Logo" class="h-8 mx-auto brightness-200">
